...
- Three playable doomscrollers, picked on a title-screen turntable (swipe left/right): Hoodie Goblin (craves Reels), Grindset Bro (Notifications), iPad Kid (Likes). The favourite content gives +50% but builds tolerance faster; physics identical. All faceless, lit by their screen. Meshes: one Blender script, shared rig + clips, per-character outfits in one .glb.
